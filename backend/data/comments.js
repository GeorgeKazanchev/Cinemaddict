const comments = [
...

  {
    ...
    comment: 'It\'s hard to believe this movie did not get censorship approval. No where in the film do the characters '
...

  {
    ...
    comment: 'As a whole, this movie doesn\'t work at all. Different parts of the story jump around here and there '
...

  {
    ...
    comment: 'This film is a monumental piece of film history. I can honestly it might just be one of the best movies of all time. '
